...
window.ProvisionEmpleosAdmin = (() => {
    ...
    function getElements() {
        return {
            ...
            cancelContainer: document.getElementById('provisionEmpleosCancelContainer')
        };
    }
    ...
    function render() {
        ...
        if (items.length === 0) {
            els.list.innerHTML = '<p style="padding:1.5rem; text-align:center; color:#64748b;">No hay documentos registrados.</p>';
            return;
        }
    ...
    async function handleSubmit(e) {
        ...
        const desc = document.getElementById('provisionEmpleosDescription').value.trim();
    ...
    function editByBtn(id) {
        ...
        document.getElementById('provisionEmpleosDescription').value = item.description || '';
