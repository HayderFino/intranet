...
class PlanMonitoreoModel {
    constructor() {
        this.htmlPath = path.join(__dirname, '../../header_menu/cas/plan-monitoreo-sigep.html');
        // Carpeta física según solicitud
        this.dataDir = path.join(__dirname, '../../data/menu header/la cas/talento humano/Plan de monitoreo del SIGEP');
    }
    ...
    update(id, newData) {
        ...
        if (match) {
            ...
            let fileUrl = newData.filename ? `../../data/menu header/la cas/talento humano/Plan de monitoreo del SIGEP/${newData.filename}` : null;
