...
const HTML_PATH = 'c:/Users/HAYDER/Videos/intranet/intranet/header_menu/sgi/politicas.html';
...
if (fs.existsSync(HTML_PATH)) {
    ...
    const blockRegex = /<!-- Documentos descargables[^>]*>[\s\S]*?<div class="pdf-grid" id="politicas-docs-grid"[\s\S]*?<!-- BEGIN_POLITICAS_DOCS -->[\s\S]*?<!-- END_POLITICAS_DOCS -->[\s\S]*?<\/div>/;
    ...
    const containerRegex = /(article[^>]*data-id="static-vial"[\s\S]*?<\/article>\s*)(<\/div>)/;
