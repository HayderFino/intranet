...
window.ConvocatoriasAdmin = (() => {
    ...
    async function load() {
        ...
        els.list.innerHTML = '<p style="padding:1rem;">Cargando convocatoria...</p>';
        try {
    ...
    function render() {
        ...
        if (items.length === 0) {
            els.list.innerHTML = '<p style="padding:1.5rem; text-align:center; color:#64748b;">No hay convocatorias registradas.</p>';
            return;
        }
    ...
    async function handleSubmit(e) {
        ...
        const desc = document.getElementById('convocatoriasDescription').value.trim();
    ...
    function editByBtn(id) {
        ...
        document.getElementById('convocatoriasDescription').value = item.description || '';
