...
window.EstudiosTecnicosAdmin = (() => {
    ...
    function getElements() {
        return {
            ...
            cancelContainer: document.getElementById('estudiosTecnicosCancelContainer')
        };
    }
    ...
    async function handleSubmit(e) {
        ...
        const desc = document.getElementById('estudiosTecnicosDescription').value.trim();
    ...
    function editByBtn(id) {
        ...
        document.getElementById('estudiosTecnicosDescription').value = item.description || '';
